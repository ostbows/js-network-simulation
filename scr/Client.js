...
Client.prototype.processInputs = function() {
  ...
  if (this.key_right) {
    ...
    // Reset input sequence number every 3 sec idling.
    this.input_reset_timer -= dt_sec;

    if (this.input_reset_timer < 0) {
      this.input_reset_timer = 3;

      if (!this.pending_inputs.length) {
        this.input_sequence_number = 0;
      }
